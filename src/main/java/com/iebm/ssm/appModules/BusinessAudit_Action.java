...
import com.iebm.ssm.pageObjects.BusinessAuditPage;
...
/**
 * @Auther: LC
 * @Date: 2019/3/14 18:14
 * @Description:
 */

public class BusinessAudit_Action {

    private BusinessAuditPage page;

    public BusinessAudit_Action() throws Exception {
        this.page = new BusinessAuditPage(Constant.driver);
    }
    ...
    public void queryBusinessAuditCase(String index, String hospital, String hospital_level, String disease, String illegalclass, String startdate, String enddate, String sicode, String accept, String remar, String enable) throws Exception {
