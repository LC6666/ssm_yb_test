...
public class ReviewSencondTest {
    ...
    @DataProvider(name = "getqueryReviewCaseData")
    public Object[][] getqueryReviewCaseData() throws ClassNotFoundException {
    ...
    public void queryReviewCase(String index,String hospital,String hospital_level,String disease,String startdate,String endate,String illegalClass,String sicode,String nextState,String remark,String enable) throws Exception {
        reviewSencond_action.queryReviewCase(index,hospital,hospital_level,disease,startdate,endate,illegalClass,sicode,nextState,remark,enable);
    }
